...
;Answer: lpm can be used to load into other registers and sts can be used to store data 
;from any register
;-------------------------
; Your code goes here:
;
	clr r0 ; clear the value of r0
	lds r0,A ; load A into r0
	lds r17,B ; load B into r17
	lds r18,C ; load C into r18
	add r0,r17 ;add r17 to r0
	add r0,r18 ;add r18 to r0
	sts D,r0 ; store the value of r0 into the memory lovation D		
